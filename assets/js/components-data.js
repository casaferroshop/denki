...
<header id="main-header">
    <nav class="container">
        <a href="{{root}}" class="logo">
            <img src="{{root}}assets/img/logo-mobile.webp" width="1024" height="329" loading="lazy" decoding="async" alt="Clínica Denki Logo">
        </a>
        ...
        <div class="f-grid">
            <div class="f-info">
                <a href="{{root}}" class="logo" style="margin-bottom: 1.5rem; display: block;">
                    <img src="{{root}}assets/img/logo-mobile.webp" width="1024" height="329" loading="lazy" decoding="async" style="height: 40px" alt="Clínica Denki Logo">
                </a>
