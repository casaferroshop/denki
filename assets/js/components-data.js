...
<header id="main-header">
    <nav class="container">
        <a href="{{root}}" class="logo">
            <img src="{{root}}assets/img/logo-mobile-w480.webp" srcset="{{root}}assets/img/logo-mobile-w480.webp 480w, {{root}}assets/img/logo-mobile-w960.webp 960w" sizes="150px" width="150" height="48" loading="eager" decoding="async" alt="Clínica Denki Logo">
        </a>
...
<div id="mobile-menu" class="mobile-menu-overlay">
    <div class="mobile-menu-content">
        ...
        <ul class="mobile-nav-links">
            ...
            <li><hr></li>
            <li class="mobile-section-title"><strong>Por condición</strong></li>
            <li><a href="{{root}}nutricion-metabolica/diabetes/">Diabetes</a></li>
            <li><a href="{{root}}nutricion-metabolica/bajar-glucosa/">Bajar Glucosa</a></li>
            <li><a href="{{root}}nutricion-cardiovascular/colesterol-alto/">Colesterol Alto</a></li>
            <li><a href="{{root}}nutricion-cardiovascular/trigliceridos-altos/">Triglicéridos Altos</a></li>
            <li><a href="{{root}}nutricion-neurologica/alzheimer/">Alzheimer</a></li>
            <li><a href="{{root}}nutricion-neurologica/parkinson/">Parkinson</a></li>
            <li><a href="{{root}}nutricion-neurologica/infarto-cerebral/">Infarto Cerebral</a></li>
            <li><a href="{{root}}nutricion-oncologica/cancer/">Cáncer & Quimio</a></li>
            <li><a href="{{root}}nutricion-geriatrica/adulto-mayor/">Adulto Mayor</a></li>
            <li><a href="{{root}}nutricion-geriatrica/sarcopenia/">Sarcopenia</a></li>
            <li><hr></li>
        ...
        <div class="f-grid">
            <div class="f-info">
                <a href="{{root}}" class="logo" style="margin-bottom: 1.5rem; display: block;">
                    <img src="{{root}}assets/img/logo-mobile-w480.webp" srcset="{{root}}assets/img/logo-mobile-w480.webp 480w, {{root}}assets/img/logo-mobile-w960.webp 960w" sizes="120px" width="120" height="39" loading="lazy" decoding="async" style="height: 40px" alt="Clínica Denki Logo">
                </a>
                ...
                <div style="margin-top: 1.5rem;">
                    ...
                    <p style="color: #99aab5; font-size: 0.9rem;">📞 <a href="tel:+525550150285" style="color: inherit;">(55) 5015 0285</a></p>
                </div>
            </div>
            <div>
                <h2 class="f-title">Especialidades</h2>
                <ul class="f-links">
                    <li><a href="{{root}}nutricion-metabolica/">Nutrición Metabólica</a></li>
                    <li><a href="{{root}}nutricion-cardiovascular/">Nutrición Cardiovascular</a></li>
                    <li><a href="{{root}}nutricion-neurologica/">Nutrición Neurológica</a></li>
            ...
            <div>
                <h2 class="f-title">Ubicaciones</h2>
                <ul class="f-links">
                    <li><a href="{{root}}ubicaciones/cdmx/">CDMX</a></li>
                    <li><a href="{{root}}ubicaciones/benito-juarez/">Benito Juárez</a></li>
                    <li><a href="{{root}}ubicaciones/roma-condesa/">Roma-Condesa</a></li>
